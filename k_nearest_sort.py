import matplotlib.pyplot as plt # to visualize the running times at the end of the program
...
size = [10**2, 10**3, 10**4, 10**5]  # given sizes
...
def print_res(arr, n, end_time): # in order to print the results in a structured way    
    print("orginal array created randomly \n", orgin_arr, "\n\n\n",
          "sorted array with randomly chosen k = ", n, "\n", arr, "\n\n with runtime: ", end_time)
